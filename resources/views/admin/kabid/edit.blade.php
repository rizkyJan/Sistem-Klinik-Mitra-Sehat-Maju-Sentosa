...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Edit Kabid</h1>
    ...
    <form
        action="{{ route('admin.kabid.update', $kabid) }}"
        method="POST"
            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        name="nip"
                        value="{{ old('nip', $kabid->nip ?? $kabid->nik) }}"
                        maxlength="50"
                        required
                ...
                <div>
                    ...
                    <input
                        ...
                        inputmode="numeric"
                        name="nik_ktp"
                        value="{{ old('nik_ktp', $kabid->nik_ktp) }}"
                        minlength="16"
                        maxlength="16"
                        required
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        name="whatsapp"
                        value="{{ old('whatsapp', $kabid->whatsapp) }}"
                        required
                ...
                <div>
                    ...
                    <select
                        ...
                        <option
                            value="{{ $department->id }}"
                            @selected((string) old('department_id', $kabid->department_id) === (string) $department->id)>
                            {{ $department->name }}
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('join_date', $kabid->join_date?->format('Y-m-d')) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <select
                        ...
                        required
                        class="w-full rounded-lg border-slate-300">
                        <option value="1" @selected((string) old('is_active', $kabid->is_active ? '1' : '0') === '1')>Aktif</option>
                        <option value="0" @selected((string) old('is_active', $kabid->is_active ? '1' : '0') === '0')>Nonaktif</option>
                    </select>
                </div>
            </div>
        </section>
            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        name="birth_place"
                        value="{{ old('birth_place', $kabid->birth_place) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('birth_date', $kabid->birth_date?->format('Y-m-d')) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="{{ $bloodType }}" @selected(old('blood_type', $kabid->blood_type) === $bloodType)>
                            {{ $bloodType }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="{{ $religion }}" @selected(old('religion', $kabid->religion) === $religion)>
                            {{ $religion }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        required
                        class="w-full rounded-lg border-slate-300"
                        placeholder="Alamat lengkap sesuai KTP">{{ old('ktp_address', $kabid->ktp_address) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        required
                        class="w-full rounded-lg border-slate-300"
                        placeholder="Alamat tempat tinggal saat ini">{{ old('domicile_address', $kabid->domicile_address) }}</textarea>
            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-3">
                <div class="md:col-span-3">
                    ...
                    <input
                        ...
                        type="text"
                        name="sip_number"
                        value="{{ old('sip_number', $kabid->sip_number) }}"
                        maxlength="100"
                ...
                <div>
                    ...
                    <input
                        ...
                        type="date"
                        name="sip_valid_from"
                        value="{{ old('sip_valid_from', $kabid->sip_valid_from?->format('Y-m-d')) }}"
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('sip_valid_until', $kabid->sip_valid_until?->format('Y-m-d')) }}"
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <div class="mb-4 flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div>
                            ...
                            <a
                                href="{{ route('admin.kabid.photo', $kabid) }}"
                                target="_blank"
                    ...
                    <x-profile-photo-cropper
                        ...
                        :required="blank($kabid->formal_photo_path)"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('bank_account_number', $kabid->bank_account_number) }}"
                                minlength="8"
                                maxlength="20"
                                required
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('bank_account_name', $kabid->bank_account_name) }}"
                                maxlength="150"
                                required
