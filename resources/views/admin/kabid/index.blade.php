...
@section('title', 'Kelola Kabid')

@section('page-title', 'Kelola Kabid')
    ...
    <div
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Kelola data dan verifikasi Kabid Mitra Sehat Maju Sentosa.
            </p>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-slate-200">
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    @forelse($kabids as $item)

                    <tr class="hover:bg-slate-50">

                        <td class="px-6 py-4 text-sm text-slate-500">

                            {{ $kabids->firstItem() + $loop->index }}
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1.5 flex flex-wrap gap-1">
                                        <span class="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-600">Kabid</span>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right">
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <button
                                    ...
                                    data-approve-url="{{ route('admin.kabid.approve', $item) }}"
                                    data-reject-url="{{ route('admin.kabid.reject', $item) }}"
                                ...
                                <form
                                    ...
                                    data-confirm-title="Hapus Kabid?"
                                    data-confirm-message="Data kabid {{ $item->name }} akan dihapus. Tindakan ini tidak dapat dibatalkan."
    ...
    <div class="relative z-10 mx-auto my-2 flex w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-2xl sm:my-6" style="max-height: calc(100dvh - 1rem);">
        ...
        <div class="shrink-0 bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3.5 text-white sm:px-6 sm:py-5">
            <div class="flex items-start justify-between gap-4">
                ...
                <div>
                    <h3 class="text-base font-bold sm:text-lg">Verifikasi Kabid</h3>
        ...
        <div id="verificationBody" class="min-h-0 flex-1 overflow-y-auto overscroll-contain p-3 sm:p-6">
            ...
            <div class="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-5 text-amber-800 sm:mt-4 sm:p-4 sm:text-sm">
                Setelah di-ACC, akun langsung aktif dan kabid dapat menggunakan fitur perizinan.
            </div>
            ...
            <div id="rejectBox" class="mt-3 hidden rounded-xl border border-red-200 bg-red-50 p-3 sm:mt-4 sm:p-4">
                ...
                <form id="rejectForm" method="POST">
                    ...
                    <p class="mt-1 text-xs text-red-600">
                        Alasan ini akan terlihat oleh kabid saat login kembali.
                    </p>
...
<div id="approveModal" class="fixed inset-0 z-[110] hidden overflow-y-auto overscroll-contain p-3 sm:p-4">
    ...
    <div class="relative z-10 mx-auto my-4 w-full max-w-sm rounded-2xl bg-white p-4 text-center shadow-2xl sm:my-8 sm:p-6">
        ...
        <p class="mt-2 text-sm leading-6 text-slate-500">
            Akun <strong id="approveName" class="text-slate-700">kabid</strong>
...
<script>
    ...
    function openApproveModal() {
        ...
        document.getElementById('approveName').textContent = selectedEmployee.name || 'kabid';
