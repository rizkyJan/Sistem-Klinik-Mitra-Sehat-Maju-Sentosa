...
@section('title', 'Buat Surat Dinas')
@section('page-title', 'Buat Surat Dinas')
...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Upload surat PDF dan pilih Karyawan/Kabid yang akan mendapatkan penugasan.
            </p>
        </div>
    </div>
    ...
    <form
        method="POST"
        action="{{ route('admin.duty-letters.store') }}"
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea
                        ...
                        class="mt-2 w-full rounded-lg border-slate-300 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 lg:grid-cols-3 sm:p-6">
                ...
                <div class="sm:col-span-2 lg:col-span-3">
                    ...
                    <textarea
                        ...
                        class="mt-2 w-full rounded-lg border-slate-300 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('location_address') }}</textarea>
                </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-5 py-4 sm:px-6">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    File surat disimpan secara private dan hanya dibuka melalui aplikasi.
                </p>
            </div>
            ...
            <div class="border-b border-slate-200 px-5 py-4 sm:px-6">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            Tidak ada proses ACC. Setelah surat disimpan, tugas langsung masuk ke akun pegawai yang dipilih.
                        </p>
                    </div>
                    ...
                    <label
                        ...
                        <div class="flex items-start gap-3">
                            <input
                                ...
                                name="assignee_ids[]"
                                value="{{ $assignee->id }}"
                                @checked(in_array($assignee->id, array_map('intval', (array) old('assignee_ids', [])), true))
