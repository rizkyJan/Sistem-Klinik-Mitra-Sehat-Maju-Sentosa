            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        name="nip"
                        value="{{ old('nip', $karyawan->nip ?? $karyawan->nik) }}"
                        maxlength="50"
                        required
                ...
                <div>
                    ...
                    <input
                        ...
                        inputmode="numeric"
                        name="nik_ktp"
                        value="{{ old('nik_ktp', $karyawan->nik_ktp) }}"
                        minlength="16"
                        maxlength="16"
                        required
                ...
                <div>
                    ...
                    <select
                        ...
                        <option
                            value="{{ $department->id }}"
                            @selected((string) old('department_id', $karyawan->department_id) === (string) $department->id)>
                            {{ $department->name }}
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('join_date', $karyawan->join_date?->format('Y-m-d')) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <select
                        ...
                        required
                        class="w-full rounded-lg border-slate-300">
                        <option value="1" @selected((string) old('is_active', $karyawan->is_active ? '1' : '0') === '1')>Aktif</option>
                        <option value="0" @selected((string) old('is_active', $karyawan->is_active ? '1' : '0') === '0')>Nonaktif</option>
                    </select>
                </div>
            </div>
        </section>
            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        name="birth_place"
                        value="{{ old('birth_place', $karyawan->birth_place) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('birth_date', $karyawan->birth_date?->format('Y-m-d')) }}"
                        required
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="{{ $bloodType }}" @selected(old('blood_type', $karyawan->blood_type) === $bloodType)>
                            {{ $bloodType }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="{{ $religion }}" @selected(old('religion', $karyawan->religion) === $religion)>
                            {{ $religion }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        required
                        class="w-full rounded-lg border-slate-300"
                        placeholder="Alamat lengkap sesuai KTP">{{ old('ktp_address', $karyawan->ktp_address) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        required
                        class="w-full rounded-lg border-slate-300"
                        placeholder="Alamat tempat tinggal saat ini">{{ old('domicile_address', $karyawan->domicile_address) }}</textarea>
            ...
            <div class="grid grid-cols-1 gap-5 p-5 sm:p-6 md:grid-cols-3">
                <div class="md:col-span-3">
                    ...
                    <input
                        ...
                        type="text"
                        name="sip_number"
                        value="{{ old('sip_number', $karyawan->sip_number) }}"
                        maxlength="100"
                ...
                <div>
                    ...
                    <input
                        ...
                        type="date"
                        name="sip_valid_from"
                        value="{{ old('sip_valid_from', $karyawan->sip_valid_from?->format('Y-m-d')) }}"
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('sip_valid_until', $karyawan->sip_valid_until?->format('Y-m-d')) }}"
                        class="w-full rounded-lg border-slate-300">
                ...
                <div>
                    ...
                    <div class="mb-4 flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div>
                            ...
                            <a
                                href="{{ route('admin.karyawan.photo', $karyawan) }}"
                                target="_blank"
