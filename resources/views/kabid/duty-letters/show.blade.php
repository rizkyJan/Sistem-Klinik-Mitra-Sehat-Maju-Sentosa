...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div class="min-w-0">
            <a href="{{ route('kabid.duty-letters.index') }}" class="inline-flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700">
        ...
        <a href="{{ route('kabid.duty-letters.pdf', $dutyAssignment) }}" target="_blank" rel="noopener" class="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-red-700">
    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,1.5fr)_minmax(320px,0.8fr)]">
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-t border-slate-100 bg-slate-50 px-5 py-4 sm:px-6">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        @if($canWriteReport)
                        <a
                            href="{{ route('kabid.duty-reports.edit', $dutyAssignment) }}"
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <a href="{{ route('kabid.duty-letters.pdf', $dutyAssignment) }}" target="_blank" rel="noopener" class="mt-4 inline-flex w-full items-center justify-center rounded-lg border border-red-200 bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-700 transition hover:bg-red-100">
