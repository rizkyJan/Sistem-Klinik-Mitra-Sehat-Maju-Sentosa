...
<div class="mx-auto max-w-5xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <a
                href="{{ route('karyawan.duty-letters.show', $dutyAssignment) }}"
    ...
    <form
        method="POST"
        action="{{ route('karyawan.duty-reports.store', $dutyAssignment) }}"
    ...
    <form
        ...
        method="POST"
        action="{{ route('karyawan.duty-reports.files.destroy', [$dutyAssignment, $file]) }}"
        class="hidden">
        @csrf
        @method('DELETE')
    </form>
