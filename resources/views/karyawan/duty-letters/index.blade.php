...
<div class="space-y-6">
    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-200 p-5">
            <form method="GET" action="{{ route('karyawan.duty-letters.index') }}" class="grid gap-3 lg:grid-cols-[1fr_220px_auto] lg:items-end">
                <div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('karyawan.duty-letters.index') }}" class="rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:bg-slate-50">
                        Reset
                    </a>
                    @endif
                </div>
            ...
            <div class="p-5 sm:p-6">
                <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div class="flex shrink-0 flex-col gap-2 sm:flex-row xl:flex-col">
                        <a href="{{ route('karyawan.duty-letters.show', $assignment) }}" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700">
                            Lihat Detail
                        </a>

                        <a href="{{ route('karyawan.duty-letters.pdf', $assignment) }}" target="_blank" rel="noopener" class="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
                            Lihat PDF
                        </a>
                    </div>
                </div>
