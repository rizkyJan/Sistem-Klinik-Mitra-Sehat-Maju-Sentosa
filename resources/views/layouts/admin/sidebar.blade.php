        ...
        <div>
            ...
            <a
                ...
                class="
                    ...
                    rounded-lg px-3 py-2.5
                    text-sm font-medium transition
                    {{ request()->routeIs('admin.hear-you.*')
                        ? 'bg-blue-600 text-white shadow-sm'
                        : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}
                ">
                ...
                <x-sidebar-notification-badge
                    :count="$pendingHearYouResponseCount ?? 0" />
            </a>
            ...
            <a
                ...
                class="
                    ...
                    rounded-lg px-3 py-2.5
                    text-sm font-medium transition
                    {{ request()->routeIs('admin.monthly-reports.*')
                        ? 'bg-blue-600 text-white shadow-sm'
                        : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}
                ">
                ...
                <x-sidebar-notification-badge :count="$pendingMonthlyReportVerificationCount ?? 0" />
            </a>
        </div>
            ...
            <div class="space-y-1">
                <a
                    ...
                    class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition
                           {{ request()->routeIs('admin.duty-letters.*', 'admin.duty-reports.*', 'admin.duty-fees.*')
                                ? 'bg-blue-600 text-white shadow-sm'
                                : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    ...
                    <span class="truncate">Surat Dinas</span>

                    <x-sidebar-notification-badge
                        :count="$pendingDutyActionCount ?? 0" />
                </a>
            </div>
        </div>
